...
class TMDBRestApiClientImpl implements TMDBRestApiClient {
  ...
  @override
  Future<Map<String, dynamic>> delete(String url, {Map<String, dynamic>? data}) async {
  ...
  void _verifyStatusCode(int statusCode, Map<String, dynamic> responseBody) {
    ...
    switch(statusCode) {
      ...
      case 401:
      case 404:
        exception = TMDBInvalidRequestError.fromJsonResponse(responseBody);
        break;
      default:
        exception = const TMDBUnknownError('Algo inesperado aconteceu');
    }
    throw exception;
  }
}